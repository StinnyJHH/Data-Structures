...
public class StudentTests {
    ...
    public void samePriority(){
        BoundedPriorityQueue<KDPoint> myQueue = new BoundedPriorityQueue<>(5);
        myQueue.enqueue(ZERO, 5);
        myQueue.enqueue(ONEONE, 4);
        myQueue.enqueue(ONEMINUSONE, 3);
        myQueue.enqueue(MINUSONEONE, 2);
        myQueue.enqueue(ZEROMINUSONE,1);
        
        myQueue.enqueue(ONEZERO, 0.5);   // The BPQ's sorting should put this first.
        myQueue.enqueue(ZEROONE, 1.5);  // And this third.
        
        assertEquals(ONEMINUSONE, myQueue.last());
        assertEquals(myQueue.dequeue(), ONEZERO);
    }
    ...
    public void iter(){
         ...
         assertEquals(ZEROMINUSONE, iter.next());	
    }
    ...
    public void testSearch() {
        ...
        KDTree kdTree1 = new KDTree(1);
        kdTree1.insert(new KDPoint(10));
        kdTree1.insert(new KDPoint(11));
        kdTree1.insert(new KDPoint(9));
        kdTree1.insert(new KDPoint(12));
        kdTree1.insert(new KDPoint(13));
        kdTree1.insert(new KDPoint(14));
        
        
        assertTrue(kdTree.search(new KDPoint(12,18)));
        assertTrue(kdTree.search(new KDPoint(10,30)));
        assertTrue(kdTree.search(new KDPoint(-20,300)));
        assertFalse(kdTree.search(new KDPoint(-100, 20)));
        assertFalse(kdTree.search(new KDPoint(-20, 30)));
        
        assertTrue(kdTree1.search(new KDPoint(10)));
        assertTrue(kdTree1.search(new KDPoint(11)));
        assertTrue(kdTree1.search(new KDPoint(9)));
        assertTrue(kdTree1.search(new KDPoint(14)));
        assertTrue(kdTree1.search(new KDPoint(13)));
        assertEquals(4, kdTree1.height());
    }
    ...
    public void testNN() {
	     ...
	     assertEquals(new KDPoint(9),  kdTree1.nearestNeighbor(new KDPoint(8)));
	     assertEquals(new KDPoint(14),  kdTree1.nearestNeighbor(new KDPoint(20)));
	     assertEquals(new KDPoint(11),  kdTree1.nearestNeighbor(new KDPoint(10)));
    }
    ...
    public void testKNN() {
	     ...
	     kdTree1.insert(new KDPoint(13));
	     kdTree1.insert(new KDPoint(14));
	     BoundedPriorityQueue<KDPoint> temp = new BoundedPriorityQueue<>(1);
	     
	     temp.enqueue(new KDPoint(11), 3);
	     temp.enqueue(new KDPoint(13), 1);
	     temp.enqueue(new KDPoint(12), 2);
	     BoundedPriorityQueue<KDPoint> temp1 = kdTree1.kNearestNeighbors(1, new KDPoint(14));
	     
	     assertEquals(temp1.dequeue(), temp.dequeue());
	     ...
	     BoundedPriorityQueue<KDPoint> tempp = new BoundedPriorityQueue<>(1);
	     tempp.enqueue(new KDPoint(-20,300), Math.sqrt(1700));
	     assertEquals(kdTree.kNearestNeighbors(1, new KDPoint(-30,260)).dequeue(), tempp.dequeue());
    }
