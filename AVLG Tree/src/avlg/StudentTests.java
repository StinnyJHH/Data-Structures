...
public class StudentTests {
    ...
    @Test
    public void testAVL1SimpleInsert() throws EmptyTreeException, InvalidBalanceException {
    	tree = new AVLGTree<>(1);
    	tree.clear();
    	tree.insert(3);
    	tree.insert(2);
    	tree.insert(1);
    	assertEquals("should have one element", Integer.valueOf(2), tree.getRoot());
    	tree.clear();
    	assertTrue(tree.isEmpty());
    }
    
    @Test
    public void testAVL1SimpleDelete() throws EmptyTreeException, InvalidBalanceException {
    	tree = new AVLGTree<>(1);
    	tree.clear();
    	tree.insert(3);
    	tree.insert(2);
    	...
    	assertEquals("should have one element", Integer.valueOf(2), tree.getRoot());
    	tree.delete(2);
    	assertEquals("should be 3", Integer.valueOf(3), tree.getRoot());
    }
}
